...
def XGBoost_model():
    ...
    XGBoost_MODEL = XGBClassifier(learning_rate=0.1,max_depth= 3, min_child_weight= 6,
                                  silent=0,objective='multi:softmax',subsample= 0.7,
                                  gamma= 0,reg_alpha=1e-05,n_estimators= 275,
...
# 0.525154672745 0.47633744856 0.536206130609 0.533811348745 0.389894736842 0.30387713998 0.727303351861
# F_core_pos,F_core_neg,F_core_neu
# 0.428802963649 0.38791579624 0.615713674604